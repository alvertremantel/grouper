...
from grouper._win_startup import suppress_flicker
from grouper.app import MainWindow
from grouper.config import get_config
from grouper.database.connection import init_database
from grouper.styles import load_theme
from grouper.web_server import start_web_server
...
def main() -> None:
    ...
    from grouper.ui.splash import SplashScreen
    ...
    def _finish_startup() -> None:
        try:
            ...
            from grouper.version_check import VersionCheckWorker as _VCW
