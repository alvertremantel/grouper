...
from ..shared.icons import get_icon, get_themed_icon
from ..shared.link_chips import LinkChipsRow
from ..shared.widget_pool import WidgetPool
from ..shared.widgets import clear_layout, flash_checkbox_blocked, make_chip, truncate_title
from .dialogs import (
    AddBoardDialog,
    ConfirmDialog,
    CreateProjectDialog,
...
class TaskCard(BaseCard):
    ...
    def _build(self) -> None:
        ...
        TaskCard._make_child_transparent(self._title_lbl)
        ...
        TaskCard._make_child_transparent(self._tags_widget)
        ...
        TaskCard._make_child_transparent(self._prereqs_widget)
        ...
        TaskCard._make_child_transparent(self._pri_lbl)
        meta_row.addWidget(self._pri_lbl)

        self._due_lbl = QLabel()
        self._due_lbl.setObjectName("warningLabel")
        TaskCard._make_child_transparent(self._due_lbl)
...
class ProjectColumn(QFrame):
    ...
    def _quick_create_task(self) -> None:
        ...
        from desktop.ui.tasks.task_board import TaskBoardView
