...
class CreateProjectDialog(BaseFormDialog):
    ...
    def __init__(self, board_id: int, parent=None):
        super().__init__("New Project", 380, parent)
...
class EditProjectDialog(BaseFormDialog):
    ...
    def __init__(
        ...
        super().__init__("Edit Project", 380, parent)
        ...
        # Add delete button below the form (not part of the form layout)
...
class AddBoardDialog(BaseFormDialog):
    """Dialog for creating a new board."""

    def __init__(self, parent=None):
        super().__init__("New Board", 320, parent)

        self._name = QLineEdit()
        self._name.setPlaceholderText("Board name")
        self.add_row("Name:", self._name)
...
class CreateTaskDialog(BaseFormDialog):
    ...
    def __init__(
        ...
        super().__init__("New Task", 380, parent)
        self._board_id = board_id
        ...
        self.add_row("Project:", self.project_combo)
        ...
        self.add_row("Priority:", self.priority_spin)

        self.due_check, self.due_date, due_row = _build_due_date_row()
        self.add_row("Due:", due_row)
...
class EditTaskDialog(BaseFormDialog):
    """Dialog for editing an existing task."""

    def __init__(self, task, parent=None):
        super().__init__("Edit Task", 420, parent)
        self.task = task
        ...
        self._form.addRow(tags_header)

        self._tags_container = QHBoxLayout()
        self._tags_container.setSpacing(6)
        self._form.addRow(self._tags_container)
        ...
        self._form.addRow(prereqs_header)

        self._prereqs_container = QVBoxLayout()
        self._prereqs_container.setSpacing(4)
        self._form.addRow(self._prereqs_container)
        ...
        self._form.addRow(prereq_add_row)
        ...
        self._form.addRow(links_header)

        self._links_container = QVBoxLayout()
        self._links_container.setSpacing(4)
        self._form.addRow(self._links_container)
...
class AddGroupDialog(BaseFormDialog):
    ...
    def _on_accept(self):
        ...
        if self.selected_group:
            ...
            self.set_field_error(self.name_input)
